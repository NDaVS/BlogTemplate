...
public class PasswordRecoveryTokenRepositoryTests {
    @Autowired
    private PasswordRecoveryTokenRepository passwordTokenRepository;
    ...
    private final long tokenExpirationTime = 1;
    ...
    private void validateEmailToken(PasswordRecoveryToken token, User user) {
    ...
    public void EmailVerificationRepository_SaveToken_ReturnNotNull() throws InterruptedException {
        ...
        PasswordRecoveryToken savedToken = passwordTokenRepository.save(token);
    ...
    public void EmailVerificationRepository_FindByToken_ReturnToken() {
        ...
        PasswordRecoveryToken savedToken = passwordTokenRepository.findByToken(token.getToken()).orElse(null);
    ...
    public void EmailVerificationRepository_DeleteToken_ReturnExistsByIdIsFalse() {
        ...
        assertThat(passwordTokenRepository.existsById(savedToken.getId())).isFalse();
    }
}
